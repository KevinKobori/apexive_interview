...
class ApodIconCharacterKey extends XIconCharacterKey {
  const ApodIconCharacterKey._(String name) : super(name);
...
class ApodIconCharacters {
  static XIconCharactersData get data => XIconCharactersData(characters: {
